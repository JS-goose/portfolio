...
const HireLink = (props) => {
  return (
    <span className='flex bg-myRed p-2 rounded-sm cta-buttons justify-center mb-4 transform hover:scale-105 transition-all duration-700 ease-in-out sm:w-full sm:text-sm md:text-base xl:text-lg hover:underline'>
