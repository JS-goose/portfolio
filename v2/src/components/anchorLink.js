    ...
    if (props.linkType === 'internal') {
        ...
        return (<>
            <a href={props.linkAddress}
                className={`${props.styling.height} before:empty-content before:h-1 before:absolute ${props.styling.beforeBgColor} before:mt-5 hover:bg-myPurple ${props.styling.hoverTextColor}`}
